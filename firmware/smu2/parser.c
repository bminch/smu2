...
DISPATCH_ENTRY_T adc18_table[] = {{ "CH1?", adc18_ch1Q_handler }, 
                                  { "CH2?", adc18_ch2Q_handler }, 
                                  { "CH1AVG?", adc18_ch1avgQ_handler }, 
                                  { "CH2AVG?", adc18_ch2avgQ_handler }, 
                                  { "BOTH?", adc18_bothQ_handler }, 
                                  { "BOTHAVG?", adc18_bothavgQ_handler }};

#define ADC18_TABLE_ENTRIES       sizeof(adc18_table) / sizeof(DISPATCH_ENTRY_T)
...
DISPATCH_ENTRY_T mode_table[] = {{ "PORTD", portd_handler }, 
...
#define MODE_TABLE_ENTRIES      sizeof(mode_table) / sizeof(DISPATCH_ENTRY_T)
...
DISPATCH_ENTRY_T digout_table[] = {{ "SET", set_handler }, 
                                   { "CLEAR", clear_handler }, 
                                   ...
                                   { "OD", od_handler }, 
                                   { "OD?", odQ_handler }, 
                                   { "MODE", digout_mode_handler }, 
                                   { "MODE?", digout_modeQ_handler }, 
